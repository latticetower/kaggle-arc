...
class WrappedCFPredictor(Predictor):
    ...
    def is_available(self, iodata_list):
        ...
        self.op = WrappedOperation(
            ReversibleSplit((h, w), hsep=hsep, wsep=wsep, outer_sep=outer_sep),#, splitter_func=split_by_shape),
            ReversibleCombine((1, 1), hsep=0, wsep=0, outer_sep=False, sep_color=0)#, splitter_func=split_by_shape)
        )
